Installing Document-Level QuEst:
...
Running Word-Level QuEst:
	1 - Create a configuration file following the example in "quest/config/config.doc-level.properties".
	2 - Create a feature configuration file following the example in "quest/config/features/wce_features_all.xml".
	3 - Prepare the source and target input files. These files should contain 
